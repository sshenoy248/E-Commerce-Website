			...
			<nav class="navbar navbar-default">
  			...
  			<div class="container-fluid">
					<ul class="nav navbar-nav">
						<li class="active"><a href="managerview.php" class="act">View/Update Inventory</a></li>
		...
		<div class="container">
			<h2>Product Inventory</h2>
                ...
                <?php
        					...
        					$sql = "SELECT inventories.warehouseID, inventories.productID, product.productName, inventories.quantity, IF (quantity<100, 'Needs ordering', 'In stock') AS 'stockRep' FROM `inventories` JOIN product ON product.productID=inventories.productID";
                        ...
                        $productName = $row['productName'];
        								$quantity= $row['quantity'];
												$stockRep = $row['stockRep'];

        									echo "<tr class='rem1'>";
        									echo "<td class='invert'>$warehouseID</td>";
                          echo "<td class='invert'>$productID</td>";
        									echo "<td class='invert'>$productName</td>";
        									echo "<td class='invert'>";
        									echo "<p>Current: $quantity</p><br>";
        									echo "<form action='updateInventory.php' method='post'>";
        									echo "<input class='entry value' type='number' name='updateQuantity' value='$quantity' />";
        									echo "<input type='hidden' name='productID' value='$productID' />";
        									echo "<br><br>";
        									echo "<input type='submit' value='Update'>";
        									echo "</form>";
        									echo "</td>";
													echo "<td class='invert'>$stockRep</td>";
        									echo "</tr>";
        								}
