	...
	<div class="login">
		<div class="container">
			...
			<div class="login-form-grids animated wow slideInUp" data-wow-delay=".5s">
					...
					echo "<h4> Payment Amount: $totalTransactionPrice </h4><br><br>";

					echo "<form action='submitOrder.php?totalTransactionPrice=$totalTransactionPrice' method='post'>";
					?>

          <select class="input" name="cardType" type="text" required=" ">
              <option value="NULL">What is your payment method?</option>
              <option value="credit">Credit Card</option>
              <option value="debit">Debit Card</option>
          </select><br><br>
					<input name="creditCardNo" type="text" placeholder="Card Number" required=" "><br><br>
          Enter today's date:
