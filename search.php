		...
		<div class="container">
          ...
          <?php
            ...
            //}
						...
						$sql="SELECT * FROM `product` JOIN `price` ON product.priceID=price.priceID where productName LIKE '%$searchFor%' ";
						$run = mysqli_query($conn, $sql) or die('error getting query');

            $rowCount = 0;

            echo "<p><h4>Your search results for: '$searchFor'</h4></p><br><br>";
